"""
 Vamos agora usar o algoritmo de detecção de anomalias chamado Isolation Forest e ajustar seus hiperparâmetros para atingir a meta de falsos positivos e falsos negativos abaixo de 5%.
...
# n_estimators é o número de árvores no conjunto
# contamination é a taxa esperada de anomalias
