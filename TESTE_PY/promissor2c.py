...
# Calculando a importância das variáveis (desconsiderando "offset_seconds")
feature_importance = abs(decision_scores[:-1]).mean(axis=0)

# Exibindo a importância das variáveis
print("Importância das variáveis:")
for feature, importance in zip(X_train.columns[:-1], feature_importance):
