"""
Neste teste queremos garantir que todos os registros da classe normal e todos os registros da classe test-0 foram utilizados
...
# Divisão dos dados da classe "normal" para treinamento
X_train_normal, X_test_normal, y_train_normal, y_test_normal = train_test_split(
    X_train_normal, y_train_normal, test_size=0.25, random_state=42)

# Divisão dos dados da classe "test-0" para teste
X_train_test0, X_test_test0, y_train_test0, y_test_test0 = train_test_split(
    X_test_test0, y_test_test0, test_size=0.25, random_state=42)

# Concatenar os dados filtrados
X_train = np.concatenate((X_train_normal, X_train_test0), axis=0)
y_train = np.concatenate((y_train_normal, y_train_test0), axis=0)
X_test = np.concatenate((X_test_normal, X_test_test0), axis=0)
y_test = np.concatenate((y_test_normal, y_test_test0), axis=0)
