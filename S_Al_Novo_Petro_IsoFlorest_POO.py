...
class AnomalyDetectorIsolationForest:
    ...
    def train_and_predict(self):
        ...
        model.fit(self.df_train.values)  # Use .values to get a numpy array
        df_train_pred = model.predict(self.df_train.values)  # Use .values to get a numpy array
        df_test_pred = model.predict(self.df_test.values)  # Use .values to get a numpy array
